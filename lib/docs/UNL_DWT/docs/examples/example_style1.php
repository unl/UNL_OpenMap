<?php
/**
 * This example uses the DWT object generated by: '/usr/local/bin/php /Users/bbieber/Sites/UNL_OpenMap/lib/php/UNL/DWT/createTemplates.php /Users/bbieber/Sites/UNL_OpenMap/lib/docs/UNL_DWT/docs/examples/example.ini'
 * 
 */
...
if ('/Users/bbieber/Sites/UNL_OpenMap/lib/data' == '@'.'DATA_DIR@') {
    $configfile = 'example.test.ini';
} else {
    $configfile = '/Users/bbieber/Sites/UNL_OpenMap/lib/docs/UNL_DWT/docs/examples/example.ini';
}
...
$page->content .= "<p>And the command used to create the template classes:<pre><code>/usr/local/bin/php /Users/bbieber/Sites/UNL_OpenMap/lib/php/UNL/DWT/createTemplates.php /Users/bbieber/Sites/UNL_OpenMap/lib/docs/UNL_DWT/docs/examples/example.ini</code></pre></p>";
