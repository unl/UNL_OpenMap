...
<html>
	<head>
		...
		<script type="text/javascript">
			var UNL_TOUR_URL = "<?php echo UNL_OpenMap_Controller::getURL(); ?>";
			var mobile = true;
			WDN.jQuery = jQuery;
		</script>
		<script type="text/javascript" src="<?php echo UNL_OpenMap_Controller::getURL() ?>js/map.js"></script>
		<style type="text/css">
			@import url(<?php echo UNL_OpenMap_Controller::getURL() ?>css/map_mobile.css);
		</style>
	</head>
<body>
<div id="maincontent">
...
<script type="text/javascript" src="<?php echo UNL_OpenMap_Controller::getURL() ?>js/geoLocation.js"></script>
<script type="text/javascript">
