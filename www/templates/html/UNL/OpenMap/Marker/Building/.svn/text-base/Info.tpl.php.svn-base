...
<div class="infobox-content-col">
    ...
    <?php foreach ($context->images as $image) : ?>
        <?php if ($image instanceof UNL_TourMap_Marker_Image_Missing) : ?>
            <img src="<?php echo UNL_TourMap::getURL().$parent->parent->context->options['view']."/".$context->code."/image/1/lg"; ?>" alt="No Available Image" />
        <?php else : ?>
...
<div id="fullImage"><img src="<?php echo UNL_TourMap::getURL(); ?>css/images/iconLoading.gif" alt="Building Photo Loading" /></div>
