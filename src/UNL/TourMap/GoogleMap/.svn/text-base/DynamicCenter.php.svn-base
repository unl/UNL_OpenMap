<?php
class UNL_TourMap_GoogleMap_DynamicCenter extends UNL_TourMap_GoogleMap
{
    ...
    function __construct($options = array())
    {
        ...
        switch($options['view']) {
            case 'building':
                ...
                break;
            default:
                $center = new UNL_TourMap_LatLng_CityCampusCenter($options);
        }
    ...
    function getBuildingCenter($options)
    {
        ...
        if ($geo->buildingExists($options['code'])) {
            ...
            return new UNL_TourMap_LatLng(array('lat'=>$coords['lat'], 'lng'=>$coords['lon']));
        }
    ...
    {
        return new UNL_TourMap_MarkerList_Buildings();
    }
}