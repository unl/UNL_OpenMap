<?php
class UNL_TourMap_Marker_Image
{
    ...
    public function getUrl($size = null)
    {
        ...
        return UNL_TourMap::getURL() . $this->feature . '/' . $this->code
    ...
    {
        $imgDir = new DirectoryIterator(UNL_TourMap_Marker_Image::getImageDir($feature));
