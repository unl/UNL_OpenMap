...
class UNL_TourMap_OutputController extends Savvy
{
    ...
    static public function setCacheInterface(UNL_TourMap_CacheInterface $cache)
    {
        self::$cache = $cache;
    }
     ...
     * @return UNL_TourMap_CacheInterface
     */
    static public function getCacheInterface()
    {
        if (!isset(self::$cache)) {
            self::setCacheInterface(new UNL_TourMap_CacheInterface_UNLCacheLite());
        }
        return self::$cache;
    }
    ...
    {
        if ($object instanceof UNL_TourMap_CacheableInterface
            || ($object                    instanceof Savvy_ObjectProxy
                && $object->getRawObject() instanceof UNL_TourMap_CacheableInterface)) {
            ...
            if ($object instanceof UNL_TourMap_PostRunReplacements) {
