 ...
 * @author bbieber
 */
class UNL_OpenMap_CacheInterface_UNLCacheLite implements UNL_OpenMap_CacheInterface
{
    /**
     ...
     * 
     * @see UNL/UndergraduateBulletin/UNL_OpenMap_CacheInterface#get()
     */
    function get($key)
    {
     ...
     * 
     * @see UNL/UndergraduateBulletin/UNL_OpenMap_CacheInterface#save()
     */
