...
class UNL_OpenMap_MarkerList_Buildings extends FilterIterator implements UNL_OpenMap_MarkerList
{
    ...
    function current()
    {
        ...
        $position = new UNL_OpenMap_LatLng(array('lat'=>$coords['lat'], 'lng'=>$coords['lon']));
        $campus   = 'unknown';
        ...
        return new UNL_OpenMap_Marker_Building(array('position'=>$position, 'title'=>$name, 'code'=>parent::key(), 'campus'=>$campus));
    }
}