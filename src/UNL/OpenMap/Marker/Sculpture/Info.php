...
class UNL_OpenMap_Marker_Sculpture_Info extends UNL_OpenMap_Marker_Info
{
    public $sculpture;
    protected $_artists;
    ...
    function __construct($options = array())
    {
        ...
        foreach (UNL_OpenMap_Marker_Image::getImageCollection('sculpture', $this->code, $size) as $imgOpt) {
